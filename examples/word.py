...
if __name__ == "__main__":
    ...
    clipboardPanel.addSmallButton("Painter", icon=QIcon("painter.png"), showText=False,
    ...
    fontPanel.addSmallToggleButton("Underline", icon=QIcon("underline.png"), showText=False,
                                   tooltip="Underline")
    fontPanel.addSmallToggleButton("Strikethrough", icon=QIcon("strikethrough.png"), showText=False,
                                   tooltip="Strikethrough")
    fontPanel.addSmallToggleButton("Superscript", icon=QIcon("superscript.png"), showText=False,
                                   tooltip="Superscript")
    fontPanel.addSmallToggleButton("Subscript", icon=QIcon("subscript.png"), showText=False,
                                   tooltip="Subscript")
